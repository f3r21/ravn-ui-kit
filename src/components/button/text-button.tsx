...
export function TextButton({
  ...
  return (
    <button
      ...
      ref={ref}
      className={cn(
        'inline-flex items-center justify-center p-2 text-[15px] leading-6 font-normal tracking-wider rounded-sm transition-colors cursor-pointer font-sans select-none outline-none focus-visible:outline-2 focus-visible:outline-primary-4 focus-visible:outline-offset-2 disabled:pointer-events-none',
        variants[variant],
        className
      )}
    >
