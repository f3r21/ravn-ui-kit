...
/**
 * Every control live. `state` is an `OverlayTriggerState` and `ref` is a ref, so `className`
 * is the only prop a control can edit — the demo below owns the trigger and the state, which
 * is how this component is always used.
 */
